...
:DayZLingor_Skaro
cls
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Keys/skaronator.bikey
move /Y skaronator.bikey Keys
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Config/Config.pbo
Resources\cpbo.exe -Y -E Config.pbo Config_DayZLingor-Skaro > NUL
del Config.pbo
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Schema/Tables.sql
Resources\mysql.exe --user=%mysqluser% --password=%mysqlpass% --host=127.0.0.1 --port=3306 --database=%mysqldb% < Tables.sql
del Tables.sql
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Schema/Functions.sql
Resources\mysql.exe --user=%mysqluser% --password=%mysqlpass% --host=127.0.0.1 --port=3306 --database=%mysqldb% < Functions.sql
del Functions.sql
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Mission/dayz_1.lingor.pbo
move /Y dayz_1.lingor.pbo MPMissions
goto Extras_Selection
...
if exist Config_DayZLingor-Skaro (
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Extras/None.pbo
)
...
if exist Config_DayZLingor-Skaro (
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Extras/Carepkgs.pbo
)
...
if exist Config_DayZLingor-Skaro (
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Extras/Wrecks.pbo
)
...
if exist Config_DayZLingor-Skaro (
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Extras/Killmsgs.pbo
)
...
if exist Config_DayZLingor-Skaro (
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Extras/Carepkgs_Wrecks.pbo
)
...
if exist Config_DayZLingor-Skaro (
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Extras/Carepkgs_Killmsgs.pbo
)
...
if exist Config_DayZLingor-Skaro (
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Extras/Wrecks_Killmsgs.pbo
)
...
if exist Config_DayZLingor-Skaro (
Resources\wget.exe -N --quiet --no-check-certificate https://github.com/Stapo/Lite-Repo/raw/master/Mods/DayZLingor-Skaro/Extras/Carepkgs_Wrecks_Killmsgs.pbo
)
Resources\cpbo.exe -Y -E Carepkgs_Wrecks_Killmsgs.pbo @Server > NUL
del Carepkgs_Wrecks_Killmsgs.pbo
goto Finish
...
if exist Config_DayZLingor-Skaro (
set modconfig=DayZLingor-Skaro
